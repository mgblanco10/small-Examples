...
function distributeGifts(packOfGifts, reindeers) {
    ...
    const capacityReindeers = reindeers.join('').length * 2
    // console.log(capacityReindeers)

    const pesoGifts = packOfGifts.join('').length
    // console.log(pesoGifts)

    return  Math.floor(capacityReindeers /  pesoGifts)
  }
